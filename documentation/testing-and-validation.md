...
- [Testing and Validation](#testing-and-validation)
  ...
  - [Test Agent](#test-agent)
    - [Agent Analysis and Debugging Tools](#agent-analysis-and-debugging-tools)
...
- _What are the specific eligibility criteria for mortgage loans for single-family homes?_
- _What types of mortgage products does Fannie Mae offer for single-family homes?_
- _Are there any income or credit score requirements that I should be aware of?_
- _What is the minimum down payment required for a single-family home loan?_

- _What are the typical loan terms available, and are there adjustable-rate options?_
- _Are there specific requirements or standards for home inspections?_
- _Are there any penalties for paying off the mortgage early, and if so, how are they structured?_
...
<b>❗ Always select **Prepare** after making changes to apply them before testing the agent.</b>
<br/><br/>
...
6. Finally ask the agent the following question
